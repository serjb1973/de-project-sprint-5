...
@dag(
    ...
    tags=['sprint5', 'cdm', 'schema', 'dds', 'project'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)
def sprint5_dds_init_schema():
...
stg_init_schema_dag = sprint5_dds_init_schema()  # noqa
