...
class OrderLoader:
    ...
    WF_KEY = "ordersystem_orders_origin_to_stg"
    LAST_LOADED_TS_KEY = "last_loaded_ts"

    def __init__(self, collection_loader: OrderReader, pg_dest: PgConnect, pg_saver: PgSaverOrderReader, logger: Logger) -> None:
