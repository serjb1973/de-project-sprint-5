...
class RestaurantLoader:
    ...
    WF_KEY = "ordersystem_restaurants_origin_to_stg"
    LAST_LOADED_TS_KEY = "last_loaded_ts"

    def __init__(self, collection_loader: RestaurantReader, pg_dest: PgConnect, pg_saver: PgSaverRestaurantLoader, logger: Logger) -> None:
